...
const validaciones = [
    ...
    body('birthdate').trim().notEmpty().withMessage('El campo está vacio').bail().isBefore(new Date(new Date().setFullYear(new Date().getFullYear() - 16)).toString()).withMessage('Fecha no valida'),
